...
class CarCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color cardBgColor = isActuallyPromoted ? (isDark ? const Color(0xFF3E3220) : const Color(0xFFFFF9E6)) : (isDark ? const Color(0xFF242C32) : Colors.white);

    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => CarDetailsScreen(car: car, isPromoted: isActuallyPromoted)));
      },
      child: Container(
        width: 280,
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: isActuallyPromoted ? const Color(0xFFF39C12).withOpacity(isDark ? 0.3 : 0.15) : Colors.black.withOpacity(isDark ? 0.3 : 0.05), blurRadius: 15, offset: const Offset(0, 8))],
        ),
        child: Column(
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: imageUrl != null && imageUrl.isNotEmpty
                        ? CachedNetworkImage(imageUrl: imageUrl, fit: BoxFit.cover, placeholder: (context, url) => const Center(child: CircularProgressIndicator(color: AppColors.primary)), errorWidget: (context, url, error) => CachedNetworkImage(imageUrl: fallbackImage, fit: BoxFit.cover))
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: Text(model, style: TextStyle(fontWeight: FontWeight.w900, fontSize: 22, color: isDark ? Colors.white : Colors.black87), overflow: TextOverflow.ellipsis)), const Icon(Icons.chevron_right, color: AppColors.textHint, size: 24)]),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: backgroundColor != null ? AppColors.primary.withOpacity(isDark ? 0.3 : 0.1) : Colors.black.withOpacity(isDark ? 0.3 : 0.05), blurRadius: 5, offset: const Offset(0, 2))]
        ),
