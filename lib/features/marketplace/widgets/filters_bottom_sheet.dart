            ...
            return Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(AppLang.tr(context, 'filters'), style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: isDark ? Colors.white : Colors.black87)),
                    GestureDetector(
                      onTap: () {
                        cubit.clearFilters();
                        Navigator.pop(context);
                      },
                      child: Text(AppLang.tr(context, 'clear_all'), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: AppColors.primary)),
                    ),
                  ],
                ),
                ...
                // قسم الشركات (Brands)
                Text(AppLang.tr(context, 'brands'), style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppColors.textHint, letterSpacing: 1.2)),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(AppLang.tr(context, 'max_price'), style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppColors.textHint, letterSpacing: 1.2)),
                    Text(cubit.selectedMaxPrice == null ? AppLang.tr(context, 'all_brands') : "${AppLang.tr(context, 'up_to')} ${(cubit.selectedMaxPrice! / 1000000).toStringAsFixed(1)}M EGP", style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: AppColors.primary)),
                  ],
                ),
                const SizedBox(height: 16),
                SliderTheme(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(AppLang.tr(context, 'apply_filters'), style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            );
